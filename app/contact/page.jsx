...
const page = () => {
  return (
    <>
      ...
      >
        <Navbar />
        <div className="my-28 sm:my-52 px-2 flex flex-col justify-center items-center">
      ...
      <div className="bg-white shadow-custom-light mx-auto lg:w-[800px]  w-[360px] sm:w-[500px]  flex flex-col gap-8  px-2 py-6 relative top-[-140px] ">
        <div className="py-8 ">
          {" "}
          <p className="text-center text-[#444] text-[28px] font-roboto font-bold">
            GET IN TOUCH
          </p>
        </div>
        <ContactForm className="pb-5" />
      </div>
      <p className="text-center text-[24px] lg:text-[36px] font-roboto font-bold mb-12  text-[#444]relative top-[-30px]">
      ...
      <div className="flex md:flex-row  flex-col gap-3 justify-center items-center mb-12">
        ...
        <div className="flex lg:flex-row flex-col gap-3">
          <div className="min-h-[220px] gap-3  mr-3 ml-3 p-[40px] shadow-custom-light border-r-[5px] flex flex-col justify-center items-center bg-white ">
            ...
            <span className="text-base font-roboto text-center ">
              PO BOX 7053 Hicksville,
              <br /> NY 11801 US
            </span>
          </div>
          <div className="min-h-[220px] gap-3  mr-3 ml-3 p-[40px] shadow-custom-light border-r-[5px] flex flex-col justify-center items-center bg-white ">
